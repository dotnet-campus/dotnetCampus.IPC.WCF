namespace Dreamland.IPC.WCF.Message
{
    ...
    public enum ErrorCodes
    {
        ...
        /// 服务异常
        /// </summary>
        [Log("通信异常")] CommunicationException = 10000,

        /// <summary>
        /// 业务异常
        /// </summary>
        [Log("业务异常")] BusinessException = 10001,

        /// <summary>
        /// 消息Id异常
        /// </summary>
        [Log("消息Id异常（NullOrWhiteSpace）")] MessageIdNullOrWhiteSpace = 10002,
        ...
        /// </summary>
        [Log(
            "响应端消息处理查找消息Id（'RequestMessage.Id'）对应的处理方法失败，可能原因：1.未注册该消息的处理服务；2.请求端请求方法签名和响应端委托方法签名不一致（如：一端调用异步方法，另一端使用异步委托）")]
